...
# MÓDULO DE COMPRAS INTEGRADO v2.3
# ============================================================
...
ventana = tk.Tk()
ventana.title("BME-ERP - Compras Integradas v2.3")
...
combo_proveedor.bind(
    "<KeyRelease>",
    autocompletar_proveedor
)
...
entry_iva_pct.bind(
    "<KeyRelease>",
    lambda evento: recalcular_totales()
)
...
tk.Label(
    barra_estado,
    text="Compras Integradas v2.3 - FACTURA VISIBLE",
    bg=COLOR_BLANCO,
    fg=COLOR_SUAVE,
    font=("Segoe UI", 8)
).pack(side="right", padx=12)
