...
menu_procesos.add_command(
    ...
    command=lambda: abrir_modulo("ventas_integradas.py")
)
menu_procesos.add_command(
    label="Cuentas por cobrar integradas",
    command=lambda: abrir_modulo("cuentas_cobrar_integradas.py")
)
menu_procesos.add_command(
    label="Proveedores",
...
crear_boton_menu(
    sidebar,
    "$  Ventas",
    lambda: abrir_modulo("ventas_integradas.py")
)

crear_boton_menu(
    sidebar,
    "▤  Cuentas por cobrar",
    lambda: abrir_modulo("cuentas_cobrar_integradas.py")
)
...
accesos = [
    ...
    ("Ventas", lambda: abrir_modulo("ventas_integradas.py")),
    ("Cartera", lambda: abrir_modulo("cuentas_cobrar_integradas.py")),
