...
ventana.title(
    "ERP Café Alto de la Cruz - Dashboard Ejecutivo V9"
)
...
tk.Label(frame,text="INVENTARIO",font=("Arial",14,"bold")).grid(row=2,column=1,padx=30,pady=15)
...
tk.Label(frame,text="UTILIDAD ESTIMADA",font=("Arial",14,"bold")).grid(row=2,column=3,padx=30,pady=15)
