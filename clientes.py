...
from servicios.clientes_servicios import ClientesService
...
clientes_service = ClientesService(conexion)
...
def mostrar_clientes():
    ...
    registros = clientes_service.listar()
