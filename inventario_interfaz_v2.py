...
tk.Button(frame_acciones, text="Buscar", width=14, font=("Segoe UI", 9), command=lambda: accion_no_disponible("Buscar")).pack(side="left", padx=6)
tk.Button(frame_acciones, text="Editar", width=14, font=("Segoe UI", 9), command=lambda: accion_no_disponible("Editar")).pack(side="left", padx=6)
tk.Button(frame_acciones, text="Eliminar", width=14, font=("Segoe UI", 9), command=lambda: accion_no_disponible("Eliminar")).pack(side="left", padx=6)
