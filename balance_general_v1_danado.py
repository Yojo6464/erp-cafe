...
def exportar_excel():
    ...
    try:
        ...
        ws["A5"] = "Inventario Pergamino"
        ws["B5"] = inv_pergamino

        ws["A6"] = "Inventario Empaques"
        ws["B6"] = inv_empaques
        ...
        ws["A11"] = "Pasivo + Patrimonio"
        ws["B11"] = pasivo_patrimonio
        ...
        archivo = (
            rf"C:\Users\jrive\visual\BALANCE_GENERAL_{fecha}.xlsx"
        )
