...
def guardar_venta():
    ...
    try:
        ...
        messagebox.showinfo(
            "Ventas",
            "Venta guardada y descontada de inventario"
        )
...
ventana.title(
    "ERP Café Alto de la Cruz - Ventas V2"
)
...
tk.Label(frame,text="Producto").grid(
...
tk.Label(frame,text="Precio Unitario").grid(
...
tk.Label(frame,text="Forma de Pago").grid(
